...
public class HealthBarScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MAX_SIZE = staminaBar.transform.localScale;
    }
    ...
    void Update()
    {
        if (playerHealthScript.playerHealth != health_history)
        {
            ...
            if (playerHealthScript.playerStamina != stamina_history) staminaBar.transform.localScale = new Vector2(ConvertLimit(playerHealthScript.playerStamina), staminaBar.transform.localScale.y);
